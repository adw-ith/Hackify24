      ...
      >
        ...
        >
          ...
          {preferences.map((preferenceGroup, index) => (
            <option key={index} value={Object.keys(preferenceGroup)[0]}>
              {Object.keys(preferenceGroup)[0]}
            </option>
          ))}
        </select>
        ...
        >
          ...
          {selectedCategory &&
            preferences.find(
              (pref) => Object.keys(pref)[0] === selectedCategory
            )?.[selectedCategory] &&
            Object.keys(
              preferences.find(
                (pref) => Object.keys(pref)[0] === selectedCategory
        ...
        >
          ...
          {selectedCategory &&
            ...
            preferences
              .find((pref) => Object.keys(pref)[0] === selectedCategory)
              ?.[selectedCategory]?.[selectedPreference].map(
                (option: string, index: number) => (
                  <option
                    key={index}
                    value={option}
                    onClick={(e: any) => {
                      setPrefer([...prefer, e.target.value]);
                    }}
                  >
                    {option}
                  </option>
